"""
Train AutoInt model on Criteo dataset
"""
...
def main():
    parser = argparse.ArgumentParser(description='Train AutoInt on Criteo')
    ...
    for epoch in range(args.epochs):
        ...
        if val_auc > best_auc:
            ...
            torch.save(model.state_dict(), 'results/checkpoints/autoint_best.pth')
